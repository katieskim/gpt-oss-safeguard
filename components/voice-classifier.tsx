...
export function VoiceClassifier() {
  ...
  const handleRecordingComplete = async (audioBlob: Blob, duration: number) => {
    ...
    try {
      ...
      setResult({
        rating: "PG",
        riskLevel: "Low",
        summary: "Unable to classify audio. Please try again.",
        reasons: ["API error occurred", "Please verify your microphone and try again"],
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">
            Voice Content Classifier
          </h1>
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            Record your voice and get instant content classification with detailed
            analysis
          </p>
        </motion.div>
